...
<body>
	<div id="wrapper">
		<div id="f_title">追加账户资金</div>
		<form action="<c:url value="/financial_accountMgr?act=add"/>" method="post"  onSubmit="return validateFrm();">
			<div class="f_row">
			...
			<div class="f_row">
				<span>增加资金:</span> <input type="text" name="addmoney" size="20" />
			</div>
